var camera, scene, renderer, pointLight, geometry, material, mesh, auraMesh;

var uniforms, shaderMaterial;

var text, textObj, textObj2, currentSongTitle, currentSongArtist, titleMat, artistMat, 
	title3d = "title",
    artist3d = "artist",
...
$(document).ready(function() {
    ...
    function createText() {
        ...
        titleMat = new THREE.MeshPhongMaterial({
            color: 0xffdd99,
